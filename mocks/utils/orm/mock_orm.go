...
import (
	...
	orm "github.com/naufalfmm/aquafarm-management-service/utils/orm"
	gorm "gorm.io/gorm"
...
func (m *MockOrm) Association(column string) *gorm.Association {
	m.ctrl.T.Helper()
...
func (m *MockOrm) Paginate(ctx context.Context, options orm.PaginateOptions, pagingResp *orm.BasePagingResponse, data interface{}) orm.Orm {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Paginate", ctx, options, pagingResp, data)
	ret0, _ := ret[0].(orm.Orm)
	return ret0
}

// Paginate indicates an expected call of Paginate.
func (mr *MockOrmMockRecorder) Paginate(ctx, options, pagingResp, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
