...
// Source: usecases/farms/index.go

// Package mock_farmsUsecases is a generated GoMock package.
package mock_farmsUsecases
...
func (m *MockUsecases) Create(ctx context.Context, req dto.CreateFarmRequest) (dao.Farm, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecases) GetAllPaginated(ctx context.Context, req dto.FarmPagingRequest) (dao.FarmsPagingResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecases) GetByID(ctx context.Context, id uint64) (dao.Farm, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecases) Upsert(ctx context.Context, req dto.UpsertFarmRequest) (dao.Farm, error) {
	m.ctrl.T.Helper()
